package ir.zhiran2021.snamall.api
...
interface ApiService {
    ...
    @GET("home/best_sell_product.php")
    fun getBestSellProduct(): Single<List<ResponseBestSellProduct>>
    ...
    @GET("product/price_history.php")
    fun getChart(@Query("product_id")product_id:Int):Single<List<ResponseChart>>

    @GET("compare/compare_cetegories.php")
    fun getCompareCat(@Query("product_id")product_id:Int):Single<List<ResponseCompareCat>>

    @GET("compare/compare.php")
    fun getCompareProduct(@Query("product1")product1:Int,@Query("product2")product2:Int):Single<ResponseCompareProduct>
